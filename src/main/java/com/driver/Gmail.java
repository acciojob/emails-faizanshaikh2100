...
public class Gmail extends Email {
    ...
    public void deleteMail(String message){
        ...
        for(int i = 0 ; i < inbox.size();i++){
            if(inbox.get(i).message.equals(message)){
                //removing from inbox adding to trash
    ...
    public String findOldestMessage(){
        ...
        //getting msg at first index
        return inbox.get(1).message;
    }
    ...
    public int findMailsBetweenDates(Date start, Date end){
        ...
        for(int i = 0; i < inbox.size() ;i++){
            ...
            if(inbox.get(i).date.after(start) || inbox.get(i).date.before(end) || inbox.get(i).date.equals(start) || inbox.get(i).date.equals(end) ){
               count++;
            }
